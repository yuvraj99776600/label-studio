    ...
    decorator=extend_schema(
        ...
        description="""
            ...
            **For non-Community editions, this endpoint processes imports asynchronously.**
            ...
            Update this example to specify your authorization token and MLTL Annotate instance host, then run the following from
            the command line.
            ...
            Update this example to specify your authorization token, MLTL Annotate instance host, and file name and path,
