            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, help_text="Time of label creation", verbose_name="Created at"
                    ),
                ),
                ...
                (
                    "description",
                    models.TextField(blank=True, help_text="Label description", null=True, verbose_name="Description"),
                ),
                ...
                (
                    "created_by",
                    models.ForeignKey(
                        help_text="User who made this label",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="labels",
                        to=settings.AUTH_USER_MODEL,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "label",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="links", to="labels_manager.label"
                    ),
                ),
