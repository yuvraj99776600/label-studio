    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[("NONE", "None"), ("BASIC_AUTH", "Basic Auth")], default="NONE", max_length=255
            ),
        ),
        migrations.AddField(
            model_name="mlbackend",
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                blank=True, default="", help_text="HTTP Basic Auth user", null=True, verbose_name="basic auth user"
            ),
        ),
        migrations.AddField(
            model_name="mlbackend",
