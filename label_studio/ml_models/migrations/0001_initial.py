    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(blank=True, help_text="Model description", null=True, verbose_name="description"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "provider_model_id",
                    models.CharField(
                        help_text="The model ID to use within the given provider, e.g. gpt-3.5", max_length=255
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="created at")),
                ("updated_at", models.DateTimeField(auto_now=True, verbose_name="updated at")),
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="third_party_model_versions",
                        to="organizations.organization",
                    ),
                ),
                (
