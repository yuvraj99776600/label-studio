            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=None, help_text="Complete or fail time", null=True, verbose_name="finished at"
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="If true - it exports only finished tasks",
                        verbose_name="Only finished",
                    ),
                ),
                (
                    "task_ids",
                    models.JSONField(
                        default=list, help_text="If list is empty - download all tasks", verbose_name="Task ids list"
                    ),
                ),
                (
                    "created_by",
                ...
                (
                    "project",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="exports", to="projects.project"
                    ),
                ),
            ],
        ),
