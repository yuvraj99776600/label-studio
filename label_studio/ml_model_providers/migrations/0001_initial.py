        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "api_key",
                    models.TextField(
                        blank=True, help_text="Model provider API key", null=True, verbose_name="api_key"
                    ),
                ),
                (
                    "scope",
                    models.CharField(
                        choices=[("Organization", "Organization"), ("User", "User"), ("Model", "Model")],
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="model_provider_connections",
