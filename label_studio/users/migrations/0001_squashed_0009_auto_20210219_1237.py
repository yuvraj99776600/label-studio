...
class Migration(migrations.Migration):
    replaces = [
        ...
        ("users", "0003_add_tokens_to_all"),
        ("users", "0004_add_removed_user"),
        ("users", "0005_auto_20200731_1943"),
        ("users", "0006_auto_20201015_1553"),
        ("users", "0007_user_activity_at"),
        ("users", "0008_auto_20210211_1606"),
        ("users", "0009_auto_20210219_1237"),
    ]
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=django.utils.timezone.now, editable=False, verbose_name="last activity"
                    ),
                ),
            ],
            options={
