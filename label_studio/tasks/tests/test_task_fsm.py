...
class TestTaskFSMIntegration(TestCase):
    ...
    def test_task_creation_triggers_fsm(self):
        ...
        """
        # Create a task
        task = Task.objects.create(project=self.project, data={'text': 'Test task'})
    ...
    def test_task_creation_with_data_keys(self):
        ...
        task = Task.objects.create(
            project=self.project, data={'text': 'Test', 'image': 'url.jpg', 'metadata': {'key': 'value'}}, overlap=2
        )
...
class TestTaskFSMEdgeCases(TestCase):
    ...
    def test_task_creation_with_null_data(self):
        ...
        - FSM still records the transition
        """
        task = Task.objects.create(project=self.project, data=None)
    ...
    def test_multiple_task_creations(self):
        ...
        """
        task1 = Task.objects.create(project=self.project, data={'text': 'Task 1'})

        task2 = Task.objects.create(project=self.project, data={'text': 'Task 2'})
