    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "conjunction",
                    models.CharField(help_text="Type of conjunction", max_length=1024, verbose_name="conjunction"),
                ),
                (
                    "filters",
                    models.ManyToManyField(
                        help_text="Connected filters", related_name="filter_groups", to="data_manager.Filter"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ordering",
                    models.JSONField(
                        default=dict, help_text="Ordering parameters", null=True, verbose_name="ordering"
                    ),
                ),
                (
                    "filter_group",
                ...
                (
                    "selected_items",
                    models.JSONField(
                        default=dict, help_text="Selected items", null=True, verbose_name="selected items"
                    ),
                ),
                (
                    "user",
