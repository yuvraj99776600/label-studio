...
class TestCleanupInconsistentFiltergroupMigration(TestCase):
    def setUp(self):
        ...
        self.view_unaffected = View.objects.create(
            project=self.project_unaffected, filter_group=self.filter_group_unaffected
        )
    ...
    def test_migration(self):
        ...
        assert (
            AsyncMigrationStatus.objects.filter(name="0013_cleanup_inconsistent_filtergroup_20250624_2119").count()
            == 0
        )
