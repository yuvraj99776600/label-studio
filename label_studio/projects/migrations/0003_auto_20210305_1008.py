...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RenameField(
            model_name="project", old_name="enable_empty_completion", new_name="enable_empty_annotation"
        ),
        migrations.AlterField(
            model_name="project",
            name="enable_empty_annotation",
            field=models.BooleanField(
                default=True, help_text="Allow submit empty annotations", verbose_name="enable empty annotation"
            ),
        ),
        migrations.RenameField(model_name="project", old_name="maximum_completions", new_name="maximum_annotations"),
        migrations.AlterField(
            model_name="project",
        ...
        migrations.RenameField(
            model_name="project", old_name="show_completion_history", new_name="show_annotation_history"
        ),
        migrations.AlterField(
            model_name="project",
        ...
        migrations.AlterField(
            ...
            name="result_count",
            field=models.IntegerField(
                default=0, help_text="Total results inside of annotations counter", verbose_name="result count"
            ),
        ),
    ]
