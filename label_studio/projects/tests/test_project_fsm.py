...
class TestProjectFSMIntegration(TestCase):
    ...
    @pytest.mark.skip(reason='LSE-only: Project settings change tracking is LSE-specific functionality')
    def test_project_settings_change_triggers_fsm(self):
        """Test that changing project settings triggers FSM transition"""
        # This test is for LSE-specific functionality
        pass
    ...
    def test_skip_fsm_flag(self):
        ...
        # Create a project with skip_fsm=True passed to save()
        project = Project(
            title='Test Project',
            organization=self.organization,
            created_by=self.user,
        )
        project.save(skip_fsm=True)  # Skip FSM processing
...
class TestProjectFSMTransitions(TestCase):
    ...
    @pytest.mark.skip(reason="LSE-only: published/unpublished transitions don't exist in LSO")
