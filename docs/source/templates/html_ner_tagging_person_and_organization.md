...
meta_description: Template for html ner tagging with MLTL Annotate
community: true
...
repo_url: https://github.com/yuvraj99776600/awesome-label-studio-config/tree/main/label-configs/html-ner-tagging-person-and-organization
---
