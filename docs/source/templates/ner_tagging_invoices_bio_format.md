...
meta_description: Template for ner tagging for invoices (bio format) with MLTL Annotate
community: true
...
repo_url: https://github.com/yuvraj99776600/awesome-label-studio-config/tree/main/label-configs/ner-tagging-invoices-bio-format
---
