...
meta_description: Template for adding elliptical regions to images for object detection and segmentation use cases with MLTL Annotate for your machine learning and data science projects.
---
