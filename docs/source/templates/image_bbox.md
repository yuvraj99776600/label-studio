...
meta_description: Template for performing object detection with rectangular bounding boxes with MLTL Annotate for your machine learning and data science projects.
---
...
### Bounding box rotation in MLTL Annotate UI
...
### Bounding box rotation in the MLTL Annotate results

If you rotate by directly editing the rotation angle under the **Info** panel of the labeling interface, the rotation anchor point is the **top left** of the rectangle. This is also how it is saved in the MLTL Annotate `annotation.result[]['value']` (regardless of how you performed the rotation): 
