...
meta_description: Template for ocr invoices pre-ner bio format with MLTL Annotate
community: true
...
repo_url: https://github.com/yuvraj99776600/awesome-label-studio-config/tree/main/label-configs/ocr-invoices-pre-ner-bio-format
---
