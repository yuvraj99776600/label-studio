...
meta_description: Template for breast cancer mammogram classification with MLTL Annotate
community: true
...
repo_url: https://github.com/yuvraj99776600/awesome-label-studio-config/tree/main/label-configs/breast-cancer-mammogram-classification
---
