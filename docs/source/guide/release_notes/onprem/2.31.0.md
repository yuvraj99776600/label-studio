...
![Screenshot](/images/releases/2-31-markdown.png)
...
![Screenshot](/images/releases/2-31-agreement-selected.png)
...
This will open up several multi-modal use cases within chat, for example:
...
Or evaluate entire websites using an iframe:
...
![Screenshot](/images/releases/2-31-quality.png)
...
![Screenshot](/images/releases/2-31-delete.png)
