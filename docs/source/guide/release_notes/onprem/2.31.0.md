...
Helm Chart version: [1.11.6](https://github.com/yuvraj99776600/charts/blob/master/mltl/label-studio/Chart.yaml)
...
For more information, see the [PDF tag documentation](/tags/pdf) and [Blog - Inline PDF Labeling in MLTL Annotate for OCR](https://humansignal.com/blog/inline-pdf-labeling-in-label-studio-enterprise-for-ocr/).
...
Also note that now when you click on a comparison between annotators in the [**agreement matrix**](https://docs.mltl.us/guide/dashboard_members#Annotator-Agreement-Matrix), you will be taken to the Data Manager with the **Agreement (Selected**) column pre-filtered for those annotators and/or models.

For more information, see [**Agreement and Agreement (Selected) columns**](https://docs.mltl.us/guide/manage_data#Agreement-and-Agreement-Selected-columns).
...
The [**Quality section**](https://docs.mltl.us/guide/project_settings_lse#Quality) of the project settings has been improved.
...
Previously, if using a [machine learning model](ml) with a project, you had to set up your [ML backend](https://github.com/yuvraj99776600/label-studio-ml-backend) with a legacy API token.
