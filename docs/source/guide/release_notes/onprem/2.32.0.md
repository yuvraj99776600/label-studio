...
## MLTL Annotate 2.32.0

<div class="onprem-highlight">Support reports, granular permission options, new command palette</div>

*Jan 14, 2026*

Helm Chart version: [1.11.7](https://github.com/yuvraj99776600/charts/blob/master/mltl/label-studio/Chart.yaml)
...
A Support Report is a downloadable file with diagnostic and usage statistics generated from your MLTL Annotate deployment. 
...
While you can hide the **Skip** action in the [project settings](https://docs.mltl.us/guide/project_settings_lse#Annotation), this enhancement allows you to configure individual tasks so that any user in the Annotator or Reviewer role should not be able to skip them.
...
When configuring [**Annotations per task**](https://docs.mltl.us/guide/project_settings_lse#overlap) for a project, only annotations from distinct users will count towards task overlap.
