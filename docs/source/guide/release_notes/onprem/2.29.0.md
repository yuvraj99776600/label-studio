...
Helm Chart version: [1.11.2](https://github.com/yuvraj99776600/charts/blob/master/mltl/label-studio/Chart.yaml)

### New features

#### Annotate conversations with a new Chat tag

Chat conversations are now a native data type in MLTL Annotate, so you can annotate, automate, and measure like you already do for images, video, audio, and text.
...
If your project is using predictions, you will now see a **Show Models** toggle on the [Members dashboard](https://docs.mltl.us/guide/dashboard_members).
...
For more information, see [Model provider API keys for organizations](https://docs.mltl.us/guide/model_providers).
...
Note that as part of this change, the [**Access Token**](https://docs.mltl.us/guide/access_tokens) page has been moved under **Settings**.
...
We have continued to add new endpoints to our SDK. See our [**SDK releases**](https://github.com/yuvraj99776600/label-studio-sdk/releases).
