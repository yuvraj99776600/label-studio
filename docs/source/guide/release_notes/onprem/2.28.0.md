...
## MLTL Annotate 2.28.0

<div class="onprem-highlight">Bitmasks, custom hotkeys, annotation summaries, project page improvements, and more</div>

*Aug 28, 2025*

Helm Chart version: [1.11.1](https://github.com/yuvraj99776600/charts/blob/master/mltl/label-studio/Chart.yaml)
...
* [Release notes](https://github.com/yuvraj99776600/label-studio-sdk/releases/tag/2.0.0)

!!! warning
     This release contains breaking changes. If you are currently using the MLTL Annotate SDK package in any automated pipelines, we strongly recommend pinning your SDK version to <2.0.0.
...
- Fixed an issue where LDAP user signup was broken in recent MLTL Annotate versions.
