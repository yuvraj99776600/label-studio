...
## MLTL Annotate 2.30.0

<div class="onprem-highlight">Databricks storage, Reviewer metrics, multiple UX enhancements</div>

*Oct 15, 2025*

Helm Chart version: [1.11.5](https://github.com/yuvraj99776600/charts/blob/master/mltl/label-studio/Chart.yaml)


### New features

#### Connect your Databricks files to MLTL Annotate

There is a new cloud storage option to connect your Databricks Unity Catalog to MLTL Annotate.

For more information, see [**Databricks Files (UC Volumes)**](https://docs.mltl.us/guide/storage#Databricks-Files-UC-Volumes).
...
For more information, see [Project settings - Annotation](https://docs.mltl.us/guide/project_settings_lse#Annotation).
