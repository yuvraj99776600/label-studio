...
meta_title: Image segmentation in MLTL Annotate using a Grounding DINO backend
meta_description: MLTL Annotate tutorial for using Grounding DINO for zero-shot object detection in images
categories:
    - Computer Vision
    - Image Annotation
    - Object Detection
...
This tutorial uses the [`grounding_dino` example](https://github.com/yuvraj99776600/label-studio-ml-backend/tree/master/label_studio_ml/examples/grounding_dino). 
...
If you are looking for GroundingDINO integration with SAM, [check this example](https://github.com/yuvraj99776600/label-studio-ml-backend/tree/master/label_studio_ml/examples/grounding_sam).
