...
meta_description: MLTL Annotate tutorial for computer vision that showcases transfer learning for images using PyTorch and MLTL Annotate.
...
This example explains the basics of computer vision with MLTL Annotate and [PyTorch](https://pytorch.org/).
