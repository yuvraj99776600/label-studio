...
meta_description: Tutorial on how to use GLiNER with your MLTL Annotate project to complete NER tasks
categories:
...
This tutorial uses the [`gliner` example](https://github.com/yuvraj99776600/label-studio-ml-backend/tree/master/label_studio_ml/examples/gliner). 
