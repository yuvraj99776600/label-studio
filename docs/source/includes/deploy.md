## System requirements
You can install MLTL Annotate on a Linux, Windows, or MacOSX machine running Python 3.6 or later.

### Port requirements
MLTL Annotate expects port 8080 to be open by default. To use a different port, specify it when starting MLTL Annotate. See [Start MLTL Annotate](https://docs.mltl.us/guide/start). 
...
For more on using MLTL Annotate at scale and labeling performance, see [Start MLTL Annotate](https://docs.mltl.us/guide/start).
